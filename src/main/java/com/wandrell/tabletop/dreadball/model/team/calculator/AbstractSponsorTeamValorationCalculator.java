...
/**
 * Abstract team valoration calculator for an {@code SponsorTeam}. This
 * encapsulates the calculation algorithm, letting the actual implementation
 * handle the configuration values.
 * 
 * @author Bernardo Mart&iacute;nez Garrido
 */
public abstract class AbstractSponsorTeamValorationCalculator
        implements TeamValorationCalculator<SponsorTeam> {

    /**
     * Default constructor.
     */
    public AbstractSponsorTeamValorationCalculator() {
        super();
    }
